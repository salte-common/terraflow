...
> **Tip:** You can generate a pre-configured `.tfwconfig.yml` file using `terraflow new`. See the [Project Scaffolding Guide](scaffolding.md) for details.
...
You can create this file manually or generate it using `terraflow new` which creates a complete project structure with a pre-configured `.tfwconfig.yml` file tailored to your cloud provider.
